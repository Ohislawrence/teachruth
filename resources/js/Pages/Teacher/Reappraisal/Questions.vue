<!-- File: resources/js/Pages/Teacher/Reappraisal/Questions.vue -->
<template>
  <AppLayout title="Reappraisal Questions">
      ...
      <div class="max-w-3xl mx-auto">
        <div class="text-center">
          ...
          <p class="mt-2 text-lg text-gray-600">
            Answer these questions to get your updated AI-powered appraisal
          </p>
          ...
          <div class="mt-8 max-w-xl mx-auto">
            ...
            <!-- Payment Status -->
            <div class="mt-4 inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-emerald-100 text-emerald-800">
              <svg class="w-4 h-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
              Payment Verified • ₦2,500
            </div>
          </div>
        </div>
              ...
              <div class="flex justify-between pt-8 mt-6 border-t border-gray-200">
                <div>
                  ...
                  <button
                    v-else
                    type="button"
                    @click="$inertia.visit(route('teacher.reappraisal.index'))"
                    class="inline-flex items-center px-4 py-2.5 border border-gray-300 text-sm font-medium rounded-lg text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2 transition"
                  >
                    ← Back to Reappraisal
                  </button>
                ...
                <div>
                  ...
                  >
                    {{ processing ? 'Generating Appraisal...' : 'Generate New Appraisal' }}
...
const submitForm = () => {
  ...
  form.post(route('teacher.reappraisal.process'), {
    onFinish: () => {
